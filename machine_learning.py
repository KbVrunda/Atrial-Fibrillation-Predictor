...
Original file is located at
    https://colab.research.google.com/drive/1sq0DMvXgcFWaZ9qG21g1JHDzqGRifsf1
...
categorizer = tf.keras.layers.StringLookup( output_mode = 'one_hot' )
...
model.add(tf.keras.layers.Conv1D(filters=8, kernel_size=250, activation='relu'))
model.add( tf.keras.layers.MaxPool1D() )
model.add(tf.keras.layers.Dropout(0.8))
#model.add(tf.keras.layers.Conv1D(filters=10, kernel_size=3, activation='relu'))
...
my_optimizer = tf.keras.optimizers.RMSprop(my_learning_rate)
my_loss_function = tf.keras.losses.CategoricalCrossentropy()
my_metrics = [ tf.keras.metrics.CategoricalAccuracy(name="categorical_accuracy", dtype=None) ]
